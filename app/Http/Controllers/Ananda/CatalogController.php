        ...
        foreach ($catalogs as $key => $value) {
            ...
            if($exists) {
                ...
                if($value[1] > 0 ){
                    ...
                    $request->request->add(['barcode' => $icode , 'qty' =>$value[1] , 'unit_mrp' => $price_master->MRP  , 'r_price' => $price_master->MRP * $value[1] , 's_price' => $price_master->MRP * $value[1] , 'discount' => 0 , 'pdata' => '','data'=>$data, 'ogbarcode' => $icode ]);
                    //dd($request);
