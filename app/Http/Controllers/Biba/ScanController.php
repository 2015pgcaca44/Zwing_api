...
*/
    ...
    public function list(Request $request)
    {
        ...
        $vendor = DB::table('vendor')->select('id as v_id','name as vendor_name')->where('status','1')->where('deleted','0')->get();
        ...
        foreach ($scans as $key => $value) {
         ...
         return response()->json(['status' => 'list',  'data' => $data,'product_image_link' => product_image_link(), 'vendor_list' => $vendor, 'store_list' => $stores  ],200);
