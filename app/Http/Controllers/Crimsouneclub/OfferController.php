...
class OfferController extends Controller
{
	...
	public function get_offers(Request $request){
		...
		foreach($vouchers as $voucher){
			...
			$store_credit = [ 'type' => 'voucher' , 'name' => 'VMART' , 'title' => 'store credit' , 'desc' => 'On Time use',  'amount' => $voucher->amount , 'voucher_no' => $voucher->voucher_no , 'voucher_id' => $voucher->id , 'applied_status' => (in_array($voucher->id, $vouchers_ids)?true:false) , 'expired_at' => $expired_at ];
