...
namespace App\Http\Controllers\GinesysZwing;
...
class ProductController extends Controller {
	...
	public function product_details(Request $request) {
		...
		$item = DB::table('zwing_demo.invitem')->select('GRPCODE', 'INVARTICLE_CODE','BARCODE', 'CCODE1', 'CCODE2', 'CCODE3', 'CCODE4', 'CCODE5', 'CCODE6', 'ICODE', 'GENERATED', 'MRP', 'CNAME1', 'CNAME2', 'INVHSNSACMAIN_CODE', 'STOCKINDATE')->where('BARCODE', $barcode)->first();
		dd($item);
		if (!$item) {
			$itema = DB::table('zwing_demo.invitem')->select('GRPCODE', 'INVARTICLE_CODE','BARCODE', 'CCODE1', 'CCODE2', 'CCODE3', 'CCODE4', 'CCODE5', 'CCODE6', 'ICODE', 'GENERATED', 'MRP', 'CNAME1', 'CNAME2', 'INVHSNSACMAIN_CODE', 'STOCKINDATE')->where('ICODE', $barcode)->first();
			if (!$itema) {
		...
		$params = ['v_id' => $v_id, 'trans_from' => $trans_from, 'barcode' => $barcodefrom, 'qty' =>  $qty, 'mapping_store_id' => $stores->mapping_store_id , 'item' => $item, 'carts' => $carts  ];
