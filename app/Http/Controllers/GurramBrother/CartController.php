...
class CartController extends Extended_Cart_Controller {
	...
	public function get_print_receipt(Request $request) 
	{
        ...
        $terms_conditions =  array('*Tax Included in Total Invoice Value.','*No Refund, No Exchange For the Discounted & Promotional Product');
        ...
        // Closes Left & Start center
       	...
       	$printInvioce->addLine('Thank You Please Visit Again', 20,true);
