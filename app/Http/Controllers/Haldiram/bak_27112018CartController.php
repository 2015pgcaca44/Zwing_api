...
class CartController extends Controller
{
    ...
    public function order_details(Request $request)
    {
        ...
        $store = DB::table('stores')->select('delivery','store_icon')->where('store_id', $store_id)->where('v_id', $v_id)->first();
        ...
        return response()->json(['status' => 'order_details', 'message' => 'Order Details Details', 
            ...
            'store_header_logo' => store_logo_link().$store->store_icon,
            //'offer_data' => $global_offer_data,
    ...
    public function get_print_receipt(Request $request){
        ...
        foreach ($carts as $key => $cart) {
            ...
            $item_recipt[] = ['counter' => $counter ,'item_name'=>substr($cart->item_name,0, 20 ) ,'qty'=>$cart->qty];
        ...
        $print_data_array['item_recipt'] = $item_recipt; 
