...
class CartController extends Controller
{
    ...
    public function order_details(Request $request)
    {
        ...
        //dd($o_id);
        $carts = OrderDetails::where('user_id', $c_id)->where('v_id', $v_id)->where('store_id', $store_id)->where('t_order_id', $o_id->od_id)->get();
    ...
    public function get_print_receipt(Request $request){
        ...
        $stores =  DB::table('stores')->where('v_id', $v_id)->where('store_id', $store_id)->first();
        $order = Order::where('order_id', $order_id)->where('v_id', $v_id)->where('store_id', $store_id)->where('user_id', $c_id)->where('order_id', $order_id)->where('status','success')->first();

        $carts = OrderDetails::where('user_id', $c_id)->where('v_id', $v_id)->where('store_id', $store_id)->where('order_id', $order->o_id)->where('status','success')->get();
...
*/
           ...
           $cart_item_text .=
             '<tr class="td-center">
                <td colspan="3" style="text-align:left">'.$counter.' '.substr($cart->item_name, 0,20).'</td>
        ...
        <html>
            ...
            <body>
                ...
                <center>
                    <div> 
                    <img style="float:left" src="'.env('APP_URL').'/images/product/'.$v_id.'/JDE_logo.png" >
