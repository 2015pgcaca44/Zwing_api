...
class DataPushApiController extends Controller
{
    ...
    public function InvItemNewSync()
    {
        ...
        $local_path = '/home/ananda/files/item/new/'.$date.'/';
        $ftp_conn = ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login = ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist = ftp_nlist($ftp_conn, $path);

        // $custom = DB::connection()->getPdo()->exec('LOAD DATA LOCAL INFILE "/var/www/filedump/ananda/files/item/invitem-1.csv" INTO TABLE ginesys.invitem FIELDS TERMINATED BY "|"');
        ...
        foreach ($filelist as $key => $value) {
            ...
            if (empty($exists)) {
                $readfilename = 'ftp://ananda:v$mart1234@'.$ftp_server.'/'.$value;
    ...
    public function InvItemUpdateSync()
    {
        ...
        $local_path = '/home/ananda/files/item/update/'.$date.'/';
        $ftp_conn = ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login = ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist = ftp_nlist($ftp_conn, $path);
    ...
    public function InvArticleNewSync(){
        ...
        $local_path = '/home/ananda/files/article/new/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function InvArticleUpdateSync(){
        ...
        $local_path = '/home/ananda/files/article/update/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function InvGroupSync(){
        ...
        $local_path = '/home/ananda/files/group/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function InvHsnsadetNewSync(){
        ...
        $local_path = '/home/ananda/files/hsndet/new/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function InvHsnsadetUpdateSync(){
        ...
        $local_path = '/home/ananda/files/hsndet/update/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function InvHsnsacmainNewSync(){
        ...
        $local_path = '/home/ananda/files/hsnmain/new/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function InvHsnsacmainUpdateSync(){
        ...
        $local_path = '/home/ananda/files/hsnmain/update/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function InvHsnsaclabNewSync(){
        ...
        $local_path = '/home/ananda/files/hsnslab/new/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function InvHsnsaclabUpdateSync(){
        ...
        $local_path = '/home/ananda/files/hsnslab/update/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function PromoAssortmentSync(){
        ...
        $local_path = '/home/ananda/files/PromoAssortment/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function PromoAssortmentExcludeSync(){
        ...
        $local_path = '/home/ananda/files/PromoAssortment/Exclude/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function PromoAssortmentIncludeSync(){
        ...
        $local_path = '/home/ananda/files/PromoAssortment/Include/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function PromoBuyNewSync(){
        ...
        $local_path = '/home/ananda/files/PromoBuy/new/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function PromoBuyUpdateSync(){
        ...
        $local_path = '/home/ananda/files/PromoBuy/update/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function PromoMasterNewSync(){
        ...
        $local_path = '/home/ananda/files/PromoMaster/new/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function PromoMasterUpdateSync(){
        ...
        $local_path = '/home/ananda/files/PromoMaster/update/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function PromoSlabNewSync(){
        ...
        $local_path = '/home/ananda/files/promoslab/new/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function PromoSlabUpdateSync(){
        ...
        $local_path = '/home/ananda/files/promoslab/update/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function PsitePromoAssignNewSync(){
        ...
        $local_path = '/home/ananda/files/PromoAssign/new/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
    ...
    public function PsitePromoAssignUpdateSync(){
        ...
        $local_path = '/home/ananda/files/PromoAssign/update/'.$date.'/';
        $ftp_conn 	= ftp_connect($ftp_server) or die("Could not connect to $ftp_server");
        $login 		= ftp_login($ftp_conn, 'ananda', 'v$mart1234');
        $filelist 	= ftp_nlist($ftp_conn, $path);
