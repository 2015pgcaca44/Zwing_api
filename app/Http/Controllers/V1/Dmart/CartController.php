...
namespace App\Http\Controllers\V1\Dmart;
...
class CartController extends Controller
{
    ...
    public function cart_details(Request $request)
    {
            ...
            foreach ($vouchers as $key => $voucher) {
                array_push($voucher_array ,['name' => 'Dmart Credit' , 'amount' => $voucher->amount ] );
    ...
    public function get_print_receipt(Request $request){
       ...
       /* $bilLogo = '';
        ...
        $print_data_array['store_name'] = 'DMART HYPERMARKET INDIA PVT LTD';
        ...
        <html>
            ...
            <body>
                ...
                <center>
                    ...
                    <p>DMART HYPERMARKET INDIA PVT LTD</P>
                    <hr/>
                    <div class="invoice-address">
                        ...
                        <p>EMAIL - customer@dmartindia.com</P>
