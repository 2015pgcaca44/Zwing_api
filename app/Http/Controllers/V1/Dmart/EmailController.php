		...
		if(!$payments->isEmpty()){
	        ...
	        if($user->email != null && $user->email != ''){
	        	if($ord->transaction_type == 'sales'){
	            	Mail::to($user->email)->bcc('spar.zwing@maxhypermarkets.com')->send(new OrderCreated($user,$ord,$carts,$payment_method,  $complete_path , $payments));
	        	}else if($ord->transaction_type == 'return'){
	        		Mail::to($user->email)->bcc('spar.zwing@maxhypermarkets.com')->send(new OrderReturn($user,$ord,$carts,$payment_method,  $complete_path , $payments));
	        	}
	        }
