...
class CartController extends Controller
{
    ...
    public function cart_details(Request $request)
    {
            ...
            foreach ($vouchers as $key => $voucher) {
                array_push($voucher_array ,['name' => 'Hero Credit' , 'amount' => $voucher->amount ] );
	...
	public function order_receipt($c_id,$v_id , $store_id, $order_id){
        ...
        <html>
            ...
            <body>
                ...
                <center>
                    <div> 
                    <img style="float:left" src="'.store_logo_link().'hamariasha_logo.png" >
					<img style="float:right;height:30px" src="'.env('APP_URL').'/images/zwing_header.png" >

					</div>
					<div class="clearfix"></div>
                    <p>HERO HYPERMARKET INDIA PVT LTD</P>
                    <hr/>
                    <div class="invoice-address">
                        ...
                        <p>EMAIL - customer@hamariasha.com</P>
