...
class StoreController extends Controller
{
    ...
    public function store_list(Request $request)
    {
        ...
        foreach ($stores as $key => $store) {
            ...
            $store_logo    = $vendorImage->getImage($store->v_id,$vendorImage->List_Logo);
            $store_list_bg = $vendorImage->getImage($store->v_id,$vendorImage->List_Background);

            //$mgPath = store_logo_link().$store->store_logo ;
            $mgPath =  env('ADMIN_URL').$store_logo;
        ...
        return response()->json(['store_landing' => $storeLanding ,'status' => 'store_list', 'message' => 'Store List Data', 'data' => $data, 'store_logo_link' => env('ADMIN_URL'), 
    ...
    public function store_details(Request $request)
    {
        ...
        $vendorImage   = new VendorImageController();
        $store_logo    = $vendorImage->getImage($store->v_id,$vendorImage->List_Logo);
        $store_detail_img  = $vendorImage->getImage($store->v_id,$vendorImage->Store_Banner_Image);
        $resturant_img     = $vendorImage->getImage($store->v_id,$vendorImage->Restaurant_Image);
        ...
        $data['store_details_img'] = $store_detail_img;
        $data['restaurant_bg'] = $resturant_img;
        ...
        return response()->json(['status' => 'store_details', 'message' => 'Store Profile Details', 'data' => $data, 'store_logo_link' => env('ADMIN_URL'),
    ...
    public function get_settings(Request $request){
        ...
        if($store->is_restaurant == 1){
            $storearr = ['store_logo_flag' => $store_logo_flag,
