...
class VendorController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        if(Hash::check($pin, $vendor->password)) {
            ...
            $loginSession->date = date('Y-m-d H:i:s');
            $loginSession->device_id = $device_id;
            $loginSession->save();

            $userdata = array('store_id' => $vendor->store_id,'vendor_id'=>$vendor->vendor_id,'staff_id'=>$vendor->vu_id,'type'=>'Login','ip_address'=> $_SERVER['REMOTE_ADDR'],'latitude'=> $vendor->latitude,'longitude' => $vendor->longitude);
    ...
    public function logout(Request $request)
    {
        ...
        $userdata = array('store_id' => $vendor->store_id,'vendor_id'=>$vendor->vendor_id,'staff_id'=>$vendor->vu_id,'type'=>'Logout','ip_address'=> $_SERVER['REMOTE_ADDR'],'latitude'=> $vendor->latitude,'longitude' => $vendor->longitude );
    ...
    public function get_settings(Request $request){
        ...
        $return_authorization = $vendorS->getReturnAuthorizationSetting(['v_id' => $v_id, 'trans_from' => $trans_from]);
        ...
        $responseData = [
            ...
            'settlement' => [
                'opening_balance_status' => $opening_balance_status,
                'open_sesssion_compulsory' => $vendorS->getSettlementOpenSessionFunction($request)
            ],
