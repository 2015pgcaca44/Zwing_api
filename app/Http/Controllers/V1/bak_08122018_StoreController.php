...
class StoreController extends Controller
{
    ...
    public function store_list(Request $request)
    {
        ...
        return response()->json(['store_landing' => $storeLanding ,'status' => 'store_list', 'message' => 'Store List Data', 'data' => $data, 'store_logo_link' => store_logo_link(), 
    ...
    public function store_details(Request $request)
    {
        ...
        return response()->json(['status' => 'store_details', 'message' => 'Store Profile Details', 'data' => $data, 'store_logo_link' => store_logo_link(),
